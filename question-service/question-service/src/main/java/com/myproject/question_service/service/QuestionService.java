package com.myproject.question_service.service;


import com.myproject.question_service.DAOLayer.QuestionDao;
...
public class QuestionService {
    ...
    public ResponseEntity<Integer> getScore(List<Response> responses) {
        ...
        for (Response response : responses) {
            ...
            if (response.getResponses().equals(question.getRightAnswer()))
                right++;
        }
